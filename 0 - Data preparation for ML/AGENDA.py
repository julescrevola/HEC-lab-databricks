...
# MAGIC |:----:|-------|-------------|
# MAGIC | 10m    | **[Managing and Exploring Data]($./0.0 - Managing and Exploring Data/0 - Load and Explore Data)**    | Load and Explore Data<br>[Demo: Load and Explore Data]($./01 - Managing and Exploring Data)<br>[Lab: Load and Explore Data]($./01 - Managing and Exploring Data/1.LAB - Load and Explore Data)|
# MAGIC | 20m    | **[Data Preparation and Feature Engineering]($./02 - Data Preparation and Feature Engineering/2.1 - Data Imputation and Transformation Pipeline)** | Data Preparation and Feature Engineering </br> [Demo: Data Imputation and Transformation Pipeline]($./02 - Data Preparation and Feature Engineering/2.1 - Data Imputation and Transformation Pipeline) </br> [Demo: Build a Feature Engineering Pipeline]($./02 - Data Preparation and Feature Engineering/2.2 - Build a Feature Engineering Pipeline) </br> [Lab: Build a  Feature Engineering Pipeline]($./02 - Data Preparation and Feature Engineering/2.LAB - Build a  Feature Engineering Pipeline) | 
# MAGIC | 30m    | **[Feature Store]($./03 - Feature Store/3.1 - Using Feature Store for Feature Engineering)** | Feature Store </br> [Demo: Using Feature Store for Feature Engineering]($./03 - Feature Store/3.1 - Using Feature Store for Feature Engineering) </br> [Lab: Feature Engineering with Feature Store]($./03 - Feature Store/3.LAB - Feature Engineering with Feature Store) |
